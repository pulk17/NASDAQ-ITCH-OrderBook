...
em++ -O3 -std=c++20 \
  ...
  -s EXPORTED_FUNCTIONS='["_engine_create","_engine_feed","_engine_msg_count","_engine_symbol_count","_engine_locate","_engine_levels","_engine_ofi","_engine_fingerprint","_engine_symbol_at","_strategy_stat","_strategy_set_interval","_malloc","_free"]' \
